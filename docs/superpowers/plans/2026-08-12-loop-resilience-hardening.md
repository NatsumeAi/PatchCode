...
- Confirmed-bug fix: `session_id` prefers `parentSessionId`; reap skips in-process live job ids; W2 recovered retry does not recordSuccess, `allowRequest` false aborts.
