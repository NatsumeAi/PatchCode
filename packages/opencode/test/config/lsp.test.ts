...
import { ConfigLspInput } from "@opencode-ai/core/config/legacy/lsp"
...
describe("ConfigLspInput.Info refinement", () => {
  const decodeEffect = Schema.decodeUnknownSync(ConfigLspInput.Info)
