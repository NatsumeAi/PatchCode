export const dict: Record<string, string> = {
  ...
  "ui.sessionReview.expandMode": "Розгорнути або згорнути diff",
  "ui.sessionReview.filterFiles": "Фільтрувати файли",
  "ui.sessionReview.toggleSidebar": "Перемкнути дерево файлів",
  "ui.sessionReview.showAllLines": "Показати всі рядки",
  "ui.sessionReview.hideNonDiffLines": "Приховати рядки поза diff",
  "ui.sessionReview.unifiedDiff": "Об'єднаний diff",
  "ui.sessionReview.splitDiff": "Розділений diff",
  "ui.sessionReview.previousFile": "Попередній файл",
  "ui.sessionReview.nextFile": "Наступний файл",
  "ui.sessionReview.diffView": "Перегляд diff",
  "ui.sessionReview.empty.noGit.title": "Немає відстежуваних змін",
  "ui.sessionReview.empty.noGit.description": "Відстежуйте, переглядайте та скасовуйте зміни в цьому проєкті",
  "ui.sessionReview.empty.noGit.action": "Створити Git-репозиторій",
  "ui.sessionReview.empty.noGit.actionLoading": "Створення Git-репозиторію...",
  "ui.sessionReview.empty.changes.title": "Змін у файлах ще немає",
  "ui.sessionReview.empty.changes.description": "Зміни проєкту з'являться тут",
