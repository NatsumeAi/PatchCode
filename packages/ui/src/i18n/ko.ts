export const dict = {
  ...
  "ui.sessionReview.expandMode": "diff 펼치기 또는 접기",
  "ui.sessionReview.filterFiles": "파일 필터링",
  "ui.sessionReview.toggleSidebar": "파일 트리 토글",
  "ui.sessionReview.showAllLines": "모든 줄 표시",
  "ui.sessionReview.hideNonDiffLines": "변경되지 않은 줄 숨기기",
  "ui.sessionReview.unifiedDiff": "통합 diff",
  "ui.sessionReview.splitDiff": "분할 diff",
  "ui.sessionReview.previousFile": "이전 파일",
  "ui.sessionReview.nextFile": "다음 파일",
  "ui.sessionReview.diffView": "diff 보기",
  "ui.sessionReview.empty.noGit.title": "추적 중인 변경 사항 없음",
  "ui.sessionReview.empty.noGit.description": "이 프로젝트의 변경 사항을 추적, 검토 및 실행 취소",
  "ui.sessionReview.empty.noGit.action": "Git 저장소 생성",
  "ui.sessionReview.empty.noGit.actionLoading": "Git 저장소 생성 중...",
  "ui.sessionReview.empty.changes.title": "아직 파일 변경 사항 없음",
  "ui.sessionReview.empty.changes.description": "프로젝트 변경 사항이 여기에 표시됩니다",
