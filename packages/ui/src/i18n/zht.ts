...
export const dict = {
  ...
  "ui.sessionReview.expandMode": "展開或收合差異",
  "ui.sessionReview.filterFiles": "篩選檔案",
  "ui.sessionReview.toggleSidebar": "切換檔案樹",
  "ui.sessionReview.showAllLines": "顯示所有行",
  "ui.sessionReview.hideNonDiffLines": "隱藏無差異的行",
  "ui.sessionReview.unifiedDiff": "整合差異",
  "ui.sessionReview.splitDiff": "拆分差異",
  "ui.sessionReview.previousFile": "上一個檔案",
  "ui.sessionReview.nextFile": "下一個檔案",
  "ui.sessionReview.diffView": "差異檢視",
  "ui.sessionReview.empty.noGit.title": "沒有追蹤的變更",
  "ui.sessionReview.empty.noGit.description": "追蹤、檢閱及復原此專案中的變更",
  "ui.sessionReview.empty.noGit.action": "建立 Git 儲存庫",
  "ui.sessionReview.empty.noGit.actionLoading": "正在建立 Git 儲存庫...",
  "ui.sessionReview.empty.changes.title": "尚無檔案變更",
  "ui.sessionReview.empty.changes.description": "專案變更會顯示在這裡",
