export const dict = {
  ...
  "ui.sessionReview.expandMode": "差分を展開または折りたたむ",
  "ui.sessionReview.filterFiles": "ファイルを絞り込む",
  "ui.sessionReview.toggleSidebar": "ファイルツリーを切り替える",
  "ui.sessionReview.showAllLines": "すべての行を表示",
  "ui.sessionReview.hideNonDiffLines": "差分以外の行を非表示",
  "ui.sessionReview.unifiedDiff": "統合差分",
  "ui.sessionReview.splitDiff": "分割差分",
  "ui.sessionReview.previousFile": "前のファイル",
  "ui.sessionReview.nextFile": "次のファイル",
  "ui.sessionReview.diffView": "差分ビュー",
  "ui.sessionReview.empty.noGit.title": "追跡中の変更はありません",
  "ui.sessionReview.empty.noGit.description": "このプロジェクトの変更を追跡、レビュー、取り消しできます",
  "ui.sessionReview.empty.noGit.action": "Gitリポジトリを作成",
  "ui.sessionReview.empty.noGit.actionLoading": "Gitリポジトリを作成中...",
  "ui.sessionReview.empty.changes.title": "ファイルの変更はまだありません",
  "ui.sessionReview.empty.changes.description": "プロジェクトの変更がここに表示されます",
