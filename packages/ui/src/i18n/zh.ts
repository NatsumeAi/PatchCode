...
export const dict = {
  ...
  "ui.sessionReview.expandMode": "展开或折叠差异",
  "ui.sessionReview.filterFiles": "筛选文件",
  "ui.sessionReview.toggleSidebar": "切换文件树",
  "ui.sessionReview.showAllLines": "显示所有行",
  "ui.sessionReview.hideNonDiffLines": "隐藏非差异行",
  "ui.sessionReview.unifiedDiff": "统一差异",
  "ui.sessionReview.splitDiff": "拆分差异",
  "ui.sessionReview.previousFile": "上一个文件",
  "ui.sessionReview.nextFile": "下一个文件",
  "ui.sessionReview.diffView": "差异视图",
  "ui.sessionReview.empty.noGit.title": "无已跟踪的变更",
  "ui.sessionReview.empty.noGit.description": "在此项目中跟踪、审查和撤销更改",
  "ui.sessionReview.empty.noGit.action": "创建 Git 仓库",
  "ui.sessionReview.empty.noGit.actionLoading": "正在创建 Git 仓库...",
  "ui.sessionReview.empty.changes.title": "尚无文件变更",
  "ui.sessionReview.empty.changes.description": "项目变更将显示在此处",
