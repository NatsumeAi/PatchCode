export const dict = {
  ...
  "ui.sessionReview.expandMode": "Развернуть или свернуть diff",
  "ui.sessionReview.filterFiles": "Фильтровать файлы",
  "ui.sessionReview.toggleSidebar": "Переключить дерево файлов",
  "ui.sessionReview.showAllLines": "Показать все строки",
  "ui.sessionReview.hideNonDiffLines": "Скрыть строки без изменений",
  "ui.sessionReview.unifiedDiff": "Объединённый diff",
  "ui.sessionReview.splitDiff": "Разделённый diff",
  "ui.sessionReview.previousFile": "Предыдущий файл",
  "ui.sessionReview.nextFile": "Следующий файл",
  "ui.sessionReview.diffView": "Просмотр diff",
  "ui.sessionReview.empty.noGit.title": "Нет отслеживаемых изменений",
  "ui.sessionReview.empty.noGit.description": "Отслеживайте, просматривайте и отменяйте изменения в этом проекте",
  "ui.sessionReview.empty.noGit.action": "Создать репозиторий Git",
  "ui.sessionReview.empty.noGit.actionLoading": "Создание репозитория Git...",
  "ui.sessionReview.empty.changes.title": "Изменений в файлах пока нет",
  "ui.sessionReview.empty.changes.description": "Изменения проекта появятся здесь",
