...
export function Select<T>(props: SelectProps<T>) {
  ...
  return (
    <Kobalte<T, { category: string; options: T[] }>
      ...
      data-component="select-kit-root"
      ...
      sectionComponent={(sectionProps) => (
        <Kobalte.Section>
          <Show when={sectionProps.section.rawValue.category}>
            <div data-slot="menu-kit-group-label">{sectionProps.section.rawValue.category}</div>
          </Show>
        </Kobalte.Section>
      )}
      itemComponent={(itemProps) => (
        ...
        >
          <Kobalte.ItemLabel data-slot="menu-kit-item-content" as="span">
            {local.children
          ...
          <Kobalte.ItemIndicator data-slot="menu-kit-item-indicator" forceMount>
            <CheckSmall />
    ...
    >
      ...
      >
        <div data-slot="select-kit-value">
          <Kobalte.Value<T> data-slot="select-kit-value-text" class={local.valueClass}>
            {(st) => {
        ...
        <span data-slot="select-kit-chevron" aria-hidden="true">
          <ChevronDown />
        </span>
      </Kobalte.Trigger>
      <Kobalte.Portal>
        <Kobalte.Content data-component="menu-kit-content" data-slot="select-kit-content">
          <Kobalte.Listbox data-slot="select-kit-listbox" />
        </Kobalte.Content>
      </Kobalte.Portal>
    </Kobalte>
  )
