...
export const TextShimmer = <T extends ValidComponent = "span">(props: {
  ...
  return (
    ...
    >
      <span data-slot="text-shimmer-kit-char">
        <span data-slot="text-shimmer-kit-base" aria-hidden="true">
          {text()}
        </span>
        <span data-slot="text-shimmer-kit-shimmer" data-run={run() ? "true" : "false"} aria-hidden="true">
          {text()}
        </span>
      </span>
    </Dynamic>
