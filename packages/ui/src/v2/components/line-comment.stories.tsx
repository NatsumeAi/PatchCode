...
- Use \`LineCommentOverflowIcon\` inside a \`data-slot="line-comment-kit-overflow"\` button for the Figma dots control.
...
export default {
  ...
  id: "components-line-comment-kit",
  ...
  render: () => (
    <div style={{ width: "400px" }}>
      <LineComment
        ...
        actions={
          <button type="button" data-slot="line-comment-kit-overflow" aria-label="Comment actions">
