...
export function InlineInput(props: InlineInputProps) {
  ...
  return (
    ...
    >
      <div
        data-slot="inline-input-kit-prefix"
        onMouseDown={(event) => {
      ...
      >
        <span data-slot="inline-input-kit-prefix-text">{local.prefix}</span>
      </div>
      <div data-slot="inline-input-kit-divider" aria-hidden="true" />
      <div data-slot="inline-input-kit-field">
        <div data-slot="inline-input-kit-value">
          <input
            {...inputProps}
            ref={(el) => {
              input = el
        ...
        <Show when={local.showCopyButton}>
          <button
            type="button"
            data-slot="inline-input-kit-icon-button"
