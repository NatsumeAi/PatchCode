...
- **Disabled**: 50% opacity.
- Uses \`data-component="text-input"\` with \`--kit-background-bg-base\`, \`--kit-elevation-button-neutral\`, \`--kit-text-text-faint\` (placeholder), and \`--kit-icon-icon-muted\` (copy icon).
