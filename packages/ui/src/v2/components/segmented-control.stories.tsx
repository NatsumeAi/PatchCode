...
### Theming
- \`data-slot="segmented-control"\` on the track; items use \`data-slot="segmented-control-kit-item"\` and \`data-pressed\` when selected.
`

export default {
  title: "UI V2/SegmentedControl",
  id: "components-segmented-control-kit",
...
export const FullWidth = {
  render: () => (
    <div style={{ width: "320px" }}>
      <SegmentedControl defaultValue="x" class="segmented-control-kit--full-width" aria-label="Full width">
