...
export const Definitions = {
  ...
  job_promote: keybind("ctrl+shift+j", "Promote a foreground bash job to the background"),
  session_compact: keybind("<leader>c", "Compact the session"),
  session_uncompact: keybind("none", "Restore the last compaction checkpoint"),
...
export const CommandMap = {
  ...
  session_uncompact: "session.uncompact",
