...
import { kindChange, kindLabel, type Kind } from "@/components/file-tree-kit"
import { normalizePath } from "@/pages/session/kit/review-diff-kinds"
...
// Flat variant of FileTree for filtered results: reuses its data-component and
// row data-slots on purpose so file-tree.css styles both. data-highlighted has
