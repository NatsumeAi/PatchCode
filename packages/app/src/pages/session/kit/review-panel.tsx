...
import { SessionReviewFilePreview } from "@opencode-ai/session-ui/kit/session-review-file-preview"
...
import FileTree from "@/components/file-tree-kit"
...
import {
  ...
  reviewDiffNeedsLoad,
  type RenderDiff,
} from "@/pages/session/kit/review-diff-kinds"
import type { ReviewPanelState } from "@/pages/session/kit/review-panel-state"
import { applyFileListKeyDown, SessionFileList } from "@/pages/session/kit/session-file-list"
...
function ReviewPanelSidebar(props: {
  ...
  return (
    <SessionReviewSidebar
      ...
      minWidth={SESSION_REVIEW_SIDEBAR_WIDTH_MIN}
      maxWidth={SESSION_REVIEW_SIDEBAR_WIDTH_MAX}
    >
      <Show
