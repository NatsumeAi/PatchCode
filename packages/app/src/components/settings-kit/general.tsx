...
import { Select } from "@opencode-ai/ui/kit/select"
...
const AppearanceSection: Component<{ controller: AppearanceSettingsController }> = (props) => {
  ...
  return (
    <div class="settings-kit-section">
      <h3 class="settings-kit-section-title">{language.t("settings.general.section.appearance")}</h3>
      <SettingsList>
        <SettingsRow
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link class="settings-kit-link" href="https://opencode.ai/docs/themes/">
...
const SoundsSection: Component<{ controller: SoundSettingsController }> = (props) => {
  ...
  return (
    <div class="settings-kit-section">
      <h3 class="settings-kit-section-title">{language.t("settings.general.section.sounds")}</h3>
      <SettingsList>
...
export const SettingsGeneral: Component<{
  ...
  const AdvancedSection = () => (
    <div class="settings-kit-section">
      <h3 class="settings-kit-section-title">{language.t("settings.general.section.advanced")}</h3>
  ...
  const NotificationsSection = () => (
    <div class="settings-kit-section">
      <h3 class="settings-kit-section-title">{language.t("settings.general.section.notifications")}</h3>
  ...
  const UpdatesSection = () => (
    <div class="settings-kit-section">
      <h3 class="settings-kit-section-title">{language.t("settings.general.section.updates")}</h3>
  ...
  const DisplaySection = () => (
    <Show when={desktop()}>
      <div class="settings-kit-section">
        <h3 class="settings-kit-section-title">{language.t("settings.general.section.display")}</h3>
  ...
  return (
    <>
      <div class="settings-kit-tab-header">
        <h2 class="settings-kit-tab-title">{language.t("settings.tab.general")}</h2>
      </div>
