...
import type { ReferenceInfo } from "@opencode-ai/sdk/api/client"
import { createEffect, createMemo, on, Show } from "solid-js"
import { ModelSelectorPopoverKit as ModelSelectorPopover } from "@/components/dialog-select-model"
import { DialogSelectModelUnpaid } from "@/components/dialog-select-model-unpaid-kit"
...
import { PromptInput, type PromptInputSuggestion } from "@opencode-ai/session-ui/kit/prompt-input"
import {
  createPromptInputController,
  createPromptInputState,
  type PromptInputInteraction,
} from "@opencode-ai/session-ui/kit/prompt-input/interaction"

export type PromptInputComposerProps = {
  class?: string
  controller: PromptInputComposerController
  borderUnderlay?: boolean
}

export type PromptInputControllerProps = Omit<PromptInputProps, "class" | "submission">
export type PromptInputComposerController = PromptInputInteraction & {
  readonly model: PromptInputProps["controls"]["model"]
}

export function PromptInputComposer(props: PromptInputComposerProps) {
      ...
      <PromptInput
        ...
        modelControl={
          <PromptInputModelControl
            ...
            onUnpaidClick={() =>
              dialog.show(() => <DialogSelectModelUnpaid model={props.controller.model.selection} />)
            }
          />
        }
      />
...
export function usePromptInputController(props: PromptInputControllerProps): PromptInputComposerController {
  const sdk = useSDK()
  const sync = useSync()
  const files = useFile()
  ...
  const interaction = createPromptInputState()
  ...
  const context = createMemo<PromptInputSuggestion[]>(() => [
    ...references(),
  ...
  const commands = createMemo<PromptInputSuggestion[]>(() =>
  ...
  return controller as PromptInputComposerController
}

function PromptInputModelControl(props: {
  loading: boolean
  paid: boolean
  title: string
  keybind: string[]
  model: PromptInputComposerController["model"]["selection"]
  providerID?: string
  modelName: string
  onClose: () => void
  onUnpaidClick: () => void
...
function openComment(
  ...
  props: PromptInputControllerProps,
