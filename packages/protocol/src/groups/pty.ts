...
export const PtyGroup = HttpApiGroup.make("server.pty")
  ...
  .add(
    HttpApiEndpoint.post("pty.connectToken", "/api/pty/:ptyID/connect-token", {
      ...
      .annotateMerge(
        OpenApi.annotations({
          identifier: "api.pty.connectToken",
