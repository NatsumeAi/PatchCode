...
export const ProjectCopyGroup = HttpApiGroup.make("server.projectCopy")
  .add(
    HttpApiEndpoint.post("projectCopy.create", root, {
      ...
      .annotateMerge(OpenApi.annotations({ identifier: "api.projectCopy.create" })),
  )
  .add(
    HttpApiEndpoint.delete("projectCopy.remove", root, {
      ...
      .annotateMerge(locationQueryOpenApi)
      .annotateMerge(OpenApi.annotations({ identifier: "api.projectCopy.remove" })),
  )
  .add(
    HttpApiEndpoint.post("projectCopy.refresh", `${root}/refresh`, {
      ...
      .annotateMerge(locationQueryOpenApi)
      .annotateMerge(OpenApi.annotations({ identifier: "api.projectCopy.refresh" })),
  )
