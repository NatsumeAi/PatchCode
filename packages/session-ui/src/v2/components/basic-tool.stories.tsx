...
### API
- \`BasicTool\` wraps Kobalte \`Collapsible\`. Pass \`open\`, \`defaultOpen\`, and \`onOpenChange\` for controlled/uncontrolled disclosure.
- \`trigger\` accepts either a \`BasicToolTriggerTitle\` object (title, subtitle, args, changes) or arbitrary JSX.
...
### Theming
- Uses \`data-component="basic-tool"\` and slot attributes; colors via \`--bt-*\` CSS variables.
`

export default {
  title: "UI V2/BasicTool",
  id: "components-basic-tool-kit",
  component: BasicTool,
  tags: ["autodocs"],
  parameters: {
    frameBackground: "#fff",
