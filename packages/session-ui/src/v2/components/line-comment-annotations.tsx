...
import { LineCommentEditor, LineComment } from "@opencode-ai/ui/kit/line-comment"
import type { LineCommentEditorMention } from "@opencode-ai/ui/kit/line-comment"
...
export function createLineCommentController<T extends LineCommentShape>(props: LineCommentControllerProps<T>) {
  const i18n = useI18n()
