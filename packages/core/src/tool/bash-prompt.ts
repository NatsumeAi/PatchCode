...
function tmpDir() {
  return path.join(os.tmpdir(), "opencode")
}
...
If background is true, return a jobID immediately and keep the command running. Use the job tool to get, wait, or kill it.`
}

export * as BashPrompt from "./bash-prompt"
