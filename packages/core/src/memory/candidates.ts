...
export const readCandidate = Effect.fn("Memory.readCandidate")(function* (
  fs: FSUtil.Interface,
  roots: MemoryRoots,
  id: string,
) {
...
export const deleteCandidate = Effect.fn("Memory.deleteCandidate")(function* (
  fs: FSUtil.Interface,
  roots: MemoryRoots,
  id: string,
) {
...
// Compat re-exports: merge source collection lives in sources.ts.
export {
  listMergeSources,
  budgetSources,
  deleteSources,
